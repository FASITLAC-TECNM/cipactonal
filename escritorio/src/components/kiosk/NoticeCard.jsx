...
export default function NoticeCard({ notice, onClick }) {
  return (
    <div
      onClick={onClick}
      className="bg-bg-primary rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-3 border-t-4 border-amber-500 cursor-pointer transform hover:-translate-y-1 h-full"
    >
